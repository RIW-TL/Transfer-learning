...
- functions.R: This file contains the main functions used in our paper, together with functions for competing methods such as Trans-Lasso. The specific purpose of each function is documented in the inline annotations.
